document.addEventListener("DOMContentLoaded", function() {
    ...
    if (bodyDataPage === "cashflow") {
        ...
        propertiesArray.forEach((property) => {
            ...
            // Debugging outputs
            console.log("Metrics for property:", property.Address, metrics);
    
            let propertyContainer = document.querySelector(`.property[data-address="${encodedAddressJs}"]`);
    
            if (propertyContainer) {
                if (metrics.irr !== null && metrics.capRate !== null && metrics.monthlyCashFlow !== null) {
                    ...
                    console.warn("Invalid metrics for property:", property.Address, metrics);
                }
            } else {
                console.warn("Property container not found for address:", encodedAddressJs);
            }
        });
    }    
});